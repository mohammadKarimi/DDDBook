...
پیچیدگی توسط یک خطای فاحش ایجاد نمی‌شود؛ بلکه در بخش‌های کوچک جمع می‌شود. یک وابستگی یا ابهام تکی به تنهایی احتمالاً تأثیر قابل توجهی بر قابل نگهداری بودن یک سیستم نرم‌افزاری نخواهد داشت. پیچیدگی به وجود می‌آید چرا که صدها یا هزاران وابستگی و ابهام کوچک به مرور زمان ایجاد می‌شوند. در نهایت، تعداد زیادی از این مسائل کوچک به وجود می‌آیند که هر تغییر ممکن است توسط چندین مورد از آنها تحت تأثیر قرار گیرد.
