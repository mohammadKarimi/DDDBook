...
حالا که از علائم سطح بالای پیچیدگی و دلایلی که پیچیدگی توسعه نرم‌افزار را دشوار می‌کند مطلع هستید، مرحله بعدی این است که بفهمیم چه چیزهایی پیچیدگی را ایجاد می‌کنند، تا بتوانیم سیستم‌ها را به گونه‌ای طراحی کنیم که از مشکلات جلوگیری کنیم. پیچیدگی از دو عامل ناشی می‌شود: وابستگی‌ها و ابهام. این بخش در سطح بالا در مورد این عوامل بحث می‌کند؛ فصل‌های بعدی در مورد اینکه چگونه این عوامل با تصمیمات طراحی سطح پایین ارتباط دارند، بحث خواهند کرد.