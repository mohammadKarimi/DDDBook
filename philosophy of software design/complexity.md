...
در این کتاب، وابستگی وقتی وجود دارد که یک قطعه کد مشخص نمی‌تواند به تنهایی درک و اصلاح شود؛ کد به نحوی به کد دیگر مرتبط است و اگر کد داده شده تغییر کند، باید کد دیگری مورد نظر را در نظر گرفته و/یا اصلاح شود. در مثال وب‌سایت شکل 2.1 (الف)، رنگ پس‌زمینه وابستگی‌هایی بین تمام صفحات ایجاد می‌کند. همه صفحات باید دارای همان پس‌زمینه باشند، بنابراین اگر پس‌زمینه برای یک صفحه تغییر کند، باید برای همه آن‌ها تغییر کند. یک مثال دیگر از وابستگی‌ها در پروتکل‌های شبکه رخ می‌دهد. به طور معمول کد جداگانه‌ای برای فرستنده و گیرنده برای پروتکل وجود دارد، اما هرکدام باید با پروتکل هماهنگ باشند؛ تغییر کد فرستنده تقریباً همیشه نیازمند تغییرات متناظر در گیرنده است و برعکس. امضای یک متد وابستگی‌هایی را بین اجرای آن متد و کدی که آن را فراخوانی می‌کند ایجاد می‌کند: اگر یک پارامتر جدید به یک متد اضافه شود، باید تمام فراخوانی‌های آن متد اصلاح شوند تا آن پارامتر مشخص شود.