...
یکی از مهم‌ترین اهداف یک طراحی خوب این است که یک سیستم واضح باشد. این معکوس بار شناختی بالا و ناشناخته‌های ناشناخته است. در یک سیستم واضح، یک توسعه‌دهنده به سرعت می‌تواند درک کند که چگونه کد موجود کار می‌کند و چه چیزی برای انجام یک تغییر نیاز است. یک سیستم واضح، سیستمی است که یک توسعه‌دهنده می‌تواند به سرعت حدس بزند که چه کاری باید انجام دهد، بدون اینکه خیلی سخت فکر کند و با اطمینان از صحت حدس باشد. در فصل 18، تکنیک‌هایی برای تبدیل کد به چیز واضح‌تر بحث شده است.
