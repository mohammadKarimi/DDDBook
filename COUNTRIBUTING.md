# مشارکت در کتاب آموزش DDD فارسی

دم شما گرم بابت اینکه زمان و وقت و انرژی میزارید برای این کار.
## نحوه مشارکت
...
5. پس از اینکه پروژه توسط Obsidian باز شد، با پیغامی مانند تصویر زیر مواجه خواهید شد و گزینه **Trust author and enable plugins** را انتخاب کنید تا نرم‌افزار با تنظیمات و پلاگین های مناسب اجرا شود. قبل از شروع نوشتن یا بهبود بخشی باید توجه داشته باشید تمامی صفحات کتاب در مسیر **content** قرار دارد.

6. برای استفاده از ابزارهای قالب کتاب بهتر است ( تکمیل نشده) [داکیومنت راهنما] را مطالعه فرمائید.
